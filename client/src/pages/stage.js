  ...
  return (
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <ul class="col-lg-12 col-12">{submittedOffers.filter((offre) => offre.type === "Stage") .filter((offre) => {
            ...
            <li class="job-thumb d-flex">
              <div class="job-body d-flex flex-wrap flex-auto align-items-center ms-4" li key={offre._id}>
                ...
                {entretienDates[offre._id] && (
                    ...
                    {!entretienDates[offre._id] && <p>Votre candidature n'est pas encore traitée.</p>}
                    </div>
